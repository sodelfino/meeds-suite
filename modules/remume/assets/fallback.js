...
(function (raiz) {
  ...
  raiz.MEEDS_REMUMES_FALLBACK = {
    ...
    "Barbacena": [
      ...
      "Epinefrina, Bitar 0,001 mg-mL - ampola (Local de acesso: UPA)",
      ...
      "Gentamicina, Sulf. 40 mg/mL - 1 mL - ampola (Local de acesso: UPA)",
      ...
      "Ipratrópio Brom. 0,25 mg/mL-20 mL - gotas (Local de acesso: UPA)",
      ...
      "Norepinefrina, Hem. 2 mg - 4 mL - ampola (Local de acesso: UPA)",
