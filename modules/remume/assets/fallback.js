...
(function (raiz) {
  ...
  raiz.MEEDS_REMUMES_FALLBACK = {
    "_meta": {
      ...
      "avisos": {
        "Franco da Rocha": "Este atendimento é exclusivo da UPA Franco da Rocha: prescreva apenas para o paciente levar para casa. Não é possível prescrever medicação para ser administrada na unidade — se for necessário medicar no local, encaminhe para atendimento presencial."
      }
    },
    "Macaé": [
